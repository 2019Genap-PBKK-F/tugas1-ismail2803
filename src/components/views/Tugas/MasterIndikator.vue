...
var dropdownAspek = '10.199.14.46:8030/api/aspek/nama/'
// var dropdownAspek = 'http://localhost:8030/api/aspek/nama/'
export default {
  // name: 'App',
  data() {
    return {
      ...
      axios.get(host + 'api/masterindikator/').then(res => {
        ...
        var jexcelOptions = {
          ...
          columns: [
            ...
            { type: 'dropdown', title: 'Aspek', url: dropdownAspek, width: '120px' },
