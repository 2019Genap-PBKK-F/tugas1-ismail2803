...
var dropdownKategoriUnit = 'http://10.199.14.46:8030/api/kategoriunit'
// var dropdownKategoriUnit = 'http://localhost:8030/api/kategoriunit'
export default {
  // name: 'App',
  data() {
    return {
      ...
      axios.get(host + 'api/unit/').then(res => {
        ...
        var jexcelOptions = {
          ...
          columns: [
            ...
            { type: 'dropdown', title: 'Kategori', url: dropdownKategoriUnit, width: '120px' },
