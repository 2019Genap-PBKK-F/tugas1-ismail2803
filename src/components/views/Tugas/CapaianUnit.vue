...
var host = 'http://10.199.14.46:8030/api/capaianunit/'
// var host = 'http://localhost:8030/api/capaianunit/'
// var dropdownUnit = 'http://localhost:8030/api/unit/nama'
var dropdownDataDasar = 'http://10.199.14.46:8030/api/datadasar/nama/'
var dropdownSatuanKerja = 'http://10.199.14.46:8030/api/satuankerja/nama/'
// var dropdownDataDasar = 'http://localhost:8030/api/datadasar/nama/'
      ...
      axios.get(host).then(res => {
        ...
        var jexcelOptions = {
          ...
          columns: [
            ...
            { type: 'text', title: 'Waktu', width: '150px', readOnly: true },
